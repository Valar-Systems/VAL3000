...
class TMC2208Stepper : public TMCStepper {
	public:
		TMC2208Stepper(uint32_t SerialPort, float RS) :
	...
	protected:
		...
		TMC2208Stepper(uint32_t SerialPort, float RS, uint8_t addr);
...
class TMC2209Stepper : public TMC2208Stepper {
	public:
		TMC2209Stepper(uint32_t SerialPort, float RS, uint8_t addr) :
